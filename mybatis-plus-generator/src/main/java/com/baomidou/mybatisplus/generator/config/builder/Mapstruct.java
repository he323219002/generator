 ...
 * @since 3.5.0
 */
public class Mapstruct implements ITemplate {

    private final static Logger LOGGER = LoggerFactory.getLogger(Mapstruct.class);
     ...
     * @since 3.5.0
     */
    private ConverterFileName converterFileName = (entityName -> entityName + ConstVal.MAPSTRUCT);
...
//        data.put("enumerateList", tableInfo.getEnumerateList());
    ...
    public static class Builder extends BaseBuilder {
        ...
        private final Mapstruct mapstruct = new Mapstruct();
        ...
        public Builder superClass(@NotNull String superClass) {
            this.mapstruct.superClass = superClass;
            return this;
        }
        ...
        public Builder convertFileName(@NotNull ConverterFileName converter) {
            this.mapstruct.converterFileName = converter;
            return this;
        }
        ...
        public Builder fileOverride() {
            ...
            this.mapstruct.fileOverride = true;
            return this;
        }
